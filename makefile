...
CFLAGS = -Wall $(LIB) -c -fno-builtin -W -Wstrict-prototypes \
         -Wmissing-prototypes # -W开启所有警告 -Wstrict-prototypes 函数声明必须要有参数 -Wmissing-prototypes 函数必须有声明
...
hd:
	dd if=build/kernel.bin of=/Users/ntian/VirtualBoxVMs/test/hd60M.img bs=512 count=200 seek=9  conv=notrunc
